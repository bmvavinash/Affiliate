...
function ProductCard({ className, product, tag }) {
  let prd;
  let imag="https://i.postimg.cc/d37kM5z0/photo-14-16-12-2022-20-12-35.jpg";
  ...
  imag=product.photo;
  console.log('image link is '+product.photo);
  ...
  return (
    ...
    {/* </Card> */}
        ...
        <CardHeader title=
         ...
         product.text_entities[2].type=="plain"?product.text_entities[2].text:"hai":"image"
         }
         >
         </CardHeader>
        {/* //  </div> */}
        ...
        {/* <img className="product-card__image" src="../../images/1.jpeg" */}
        ...
        <Link to={{ pathname: wats }} target="_blank" >
              <button style={{ color: 'crimson', fontSize:20, lineHeight : 1 ,marginLeft: 100, fillOpacity:'blue', backgroundColor:"greenyellow"}}>Interested</button>
            </Link>
